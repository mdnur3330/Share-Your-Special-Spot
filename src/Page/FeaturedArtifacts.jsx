...
//           >
//             <div className="overflow-hidden h-30 lg:h-52">
//               <img
//                 src={artifact.image}
//                 alt={artifact.name}
...
//             <div className="p-1 lg:p-5 flex flex-col justify-between">
//               <h3 className="lg:text-xl lg:font-medium text-[#06477a] mb-1">
...
//                   className="text-white bg-[#0a70b8] hover:bg-[#085693] transition-all duration-300 btn rounded-full shadow"
//                 >
//                   View Details
//                 </Link>
//               </div>
